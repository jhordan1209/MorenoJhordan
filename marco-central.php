<div style="float:left; width:60%; margin:60px auto; padding:1vw; border-left:1px solid gray; border-right:1px solid gray;">
   <div  style="width: 100%;  ">     
    <div style="width: 100%; height:100%; margin: auto ; display:inline-block;" >
       <div style=" width:100%; height: 100%; top:0; font-size:20px; text-align:center; float:left; ">
        	<h1>¿Quién es jhordan moreno.?</h1>
       		 <hr>
             
          <div id="posteo" style="text-align: left; font-size:0.5vw;">
                Posteado por: jhordan moreno<br>
                Fecha: 2023-04-30 <br>
          </div>
        </div>
    </div>
  ...
  <div style="width: 100%; height:100%;" >
           <div  style="text-align:justify; font-size: 20px;">
                   <p class="eys-parrafo"> Hola, yo soy jhordan gusman <b> moreno panezo </b>, estudiante esmeraldeño desde el año 2019 en la Universidad Tecnica Luis Vargas Torres. 
          Desde mís estudios secundarios me he apacionado por las ciencias y la tecnología, quien  sería  por esta capacidad que tiene estas dos áres del conocimiento de solucionar muchos probemas de la sociedad. El primer lenguaje con el cual empece a programar en el el primer de universidad fue el  para ese tiempo no tenia mucho conocimiento.. </p>
...
<p class="eys-parrafo"> Por las exigencias de la universidad, ingresar a la maestria de docencia y desarrollo del curriculo, de la cual de grauduo obteniendo el título de Magister, pero despues realice otra maestría en la POLITECNICA, de Ciencias de la Computación.</p>
   <div id="blog-seccion3"  style="height: 50px;"></div>
    ...
    <h2 style="border-bottom: 1px solid green;"> Mi perfil informático</h2> 
                   ...
                   <p  class="eys-parrafo">Mi perfil tecnológico es la programación de computadoras, mi primer programa lo hice en el leguaje Basic, utilizando el computador de la espol, luego programe c++.</p> 
                   <p  class="eys-parrafo">Hoy en día he aprendido un poco de paginas web combinando HTML, CSS, JavaScrip Mis Hooby</p> 
   ...
   <div id="blog-seccion4"  style="height: 50px;"></div>
    ...
    <h2 style="border-bottom: 1px solid green;"> Mis Hooby</h2> 
                   ...
                   <p   class="eys-parrafo">me gusta mucho el deporte y tambien practicarlo. cuando tengo tiempo libre me pongo hacer un poco de ejercicio</p>
